...
import { Package, Clock, Warehouse } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <KPICard icon={<Package size={24} />}   label="My Movements Today" value={todayCount}    color="primary" loading={loading} />
        <KPICard icon={<Clock size={24} />}      label="Pending To Process" value={pendingCount}   color="warning" loading={loading} />
        <KPICard icon={<Warehouse size={24} />}  label="Storage Capacity"   value="78%"            color="success" />
      </div>
    </div>
  );
}
